<?php /*a:5:{s:73:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\user\address_list.html";i:1711000728;s:67:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\head.html";i:1711000728;s:70:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\user\left_menu.html";i:1711000728;s:68:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\foot2.html";i:1711000728;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\rightnav.html";i:1711000728;}*/ ?>
<!DOCTYPE html>
    ...
    <li> · <a href="/index/user/login_out.html">安全退出</a></li>
        ...
        <div class="user_box_right">
            ...
            <div class="user_content_box">
                ...
                <p><a  class="color1 add_address">+新增收货地址</a></p>
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                     ...
                     <?php if(is_array($addressData) || $addressData instanceof \think\Collection || $addressData instanceof \think\Paginator): $i = 0; $__LIST__ = $addressData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlentities($vo['district']); ?></td>

                        <td><?php echo htmlentities($vo['shou_address']); ?></td>

                        <td><?php echo htmlentities($vo['shou_name']); ?></td>

                        <td><?php echo htmlentities($vo['shou_mobile']); ?></td>

                        <td style="text-align: center;" attr-id="<?php echo htmlentities($vo['id']); ?>">

                            <a href="<?php echo url('shop/user/address_edit',array('id'=>$vo['id'])); ?>" class="colorblue">修改</a>

                            <a  class="colorblue delete_address" style="cursor: pointer;">删除</a>

                            <br>

                            <a  class="<?php if($vo['isdefault'] == 1): ?>color1<?php endif; ?> setdefault" href="<?php echo url('index/user/address_set_default',array('id'=>$vo['id'])); ?>" style="cursor: pointer;">默认地址</a>
...
<div class="address_box">
    ...
    <div class="address_close"><i class="layui-icon layui-icon-close color888" style="font-size: 30px;"></i></div>

    <div class="address_title text_center f24 mar_t_30">收货地址添加</div>

    <form class="address_form " method="post" action="<?php echo url('index/user/add_address_save'); ?>">
        ...
        <div class="city" data-toggle="distpicker">
            ...
            <div class="city_box">
                ...
                <select class="input" id="province1" name="province"></select>

            </div>

            <div class="city_box">

                <label class="" for="city1">城市：</label>

                <select class="input" id="city1" name="city"></select>

            </div>

            <div class="city_box">

                <label class="" for="district1">地区：</label>

                <select class="input" id="district1" name="district"></select>
        ...
        <div class="item address_info">

            <label>详细地址：</label>

            <div class="item_right">

                <input type="text" name="shou_address"  placeholder="请填写详细地址" class="input" required>
        ...
        <div class="item ">
            ...
            <div class="item_right">
                ...
                <input type="text"  name="shou_name"  placeholder="请填写姓名" class="input" required>
        ...
        <div class="item ">
            ...
            <div class="item_right">
                ...
                <input type="text"  name="shou_mobile"  placeholder="请填写电话" class="input" required>

            </div>

        </div>

        <div class="btn_box text_center mar_t_30 clear_both">
