<?php /*a:5:{s:68:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\user\myorder.html";i:1711000728;s:67:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\head.html";i:1711000728;s:70:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\user\left_menu.html";i:1711000728;s:68:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\foot2.html";i:1711000728;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\index\view\public\rightnav.html";i:1711000728;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="user_box_right">
            <div class="user_content_box">
                ...
                <div class="myorder_nav">
                    ...
                    <form action="<?php echo url('myorder_search'); ?>" method="post" class="myorder_nav_form">
                        <div class="input_box">
                            <input type="text" placeholder="<?php echo htmlentities((isset($searchkey) && ($searchkey !== '')?$searchkey:'输入商品名称')); ?>" name="searchkey">
                        </div>
                ...
                <div class="myorder_box">
                    ...
                    <div class="item 
                    <?php switch($vo['status']): case "1": ?>style_color3<?php break; case "2": ?>style_color1<?php break; case "4": ?>style_color1<?php break; default: ?>style_color2
                    <?php endswitch; ?>
                    ">
                        <div class="item_info">
                            <div class="item_info_left">
                                <div class="text2">
                                <?php switch($vo['status']): case "1": ?>待发货<?php break; case "2": ?>已完成<?php break; case "4": ?>待收货<?php break; default: ?>待支付
                                <?php endswitch; ?></div>
                        ...
                        <div class="item_goods">
                            <div class="goods_box">
                                ...
                                <div class="goods_item">
                                    ...
                                    <div class="info">
                                        <div class="goods_name"><?php echo str_replace($searchkey,"<span style='color:#f00'>".$searchkey."</span>",$vo1['goods_name']);?> &nbsp;<?php echo htmlentities($vo1['sku']); ?></div>
                            ...
                            <div class="pay_box">
                                ...
                                <?php if($vo['status'] == 2): if($vo['iscomment'] == 0): ?>
                                <div class="pay_button2"><a href="<?php echo url('index/user/myorder_comment',array('id'=>$vo['id'])); ?>" >商品评价</a></div>
                                <?php endif; ?>

                                <div class="pay_button2"><a href="<?php echo url('index/user/myorder_delete',array('id'=>$vo['id'])); ?>" >删除订单</a></div>
                                <?php endif; if($vo['status'] == 4): ?>
                                <div class="pay_button1"><a href="<?php echo url('index/user/order_status2',array('id'=>$vo['id'])); ?>" >确认收货</a></div>
