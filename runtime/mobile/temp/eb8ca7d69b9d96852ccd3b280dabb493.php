<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\privatecode0921\app\mobile\view\user\mer_edit.html";i:1707752288;s:72:"D:\phpstudy_pro\WWW\privatecode0921\app\mobile\view\public\foot_bar.html";i:1707738454;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="inner_box2">
        ...
        <div id="mer_control" class="mer_control active">
            ...
            <form action="<?php echo url('user/merchant_add'); ?>" method="post" >
                ...
                <label><input type="hidden" value="<?php echo htmlentities($id); ?>" name="id"></label><br>


                <label>商户名称</label><br>

                <label><input type="text" value="<?php echo htmlentities($mer_Data['store_name']); ?>" name="store_name"></label><br>
                <label>商户地址</label><br>

                <label><input type="text" value="<?php echo htmlentities($mer_Data['address']); ?>" name="address"></label><br>
                <label>商家姓名</label><br>

                <label><input type="text" value="<?php echo htmlentities($mer_Data['store_pic']); ?>" name="store_pic"></label><br>
                <label>行业</label><br>

                <label><input type="text" value="<?php echo htmlentities($mer_Data['name']); ?>" name="name"></label><br>
                <label>门户照片</label><br>

                <label><input type="text" value="<?php echo htmlentities($mer_Data['store_type']); ?>" name="store_type"></label><br>
                <label>收款码</label><br>

                <label><input type="text" name="payment_code_pic"><img src="<?php echo htmlentities($mer_Data['payment_code_pic']); ?>" alt=""></label><br>
        ...
        <div id="car_control" class="car_control">
            ...
            <form action="<?php echo url('user/merchant_add'); ?>" method="post">
                ...
                <label>汽车名称</label><br>
                <label><input type="text" value="<?php echo htmlentities($car_Data['car_name']); ?>" name="car_name"></label><br>
                <label>车牌号</label><br>
                <label><input type="text" value="<?php echo htmlentities($car_Data['car_number']); ?>" name="car_number"></label><br>
                <label>获取地点</label><br>
                <label><input type="text" value="<?php echo htmlentities($car_Data['address']); ?>" name="address"></label><br>
                <label>汽车照片</label><br>
                <label><input type="text"  name="car_pic"><img src="<?php echo htmlentities($car_Data['car_pic']); ?>" alt=""></label><br>
