<?php /*a:2:{s:60:"D:\phpstudy_pro\WWW\code0921\app\mobile\view\user\index.html";i:1707738454;s:65:"D:\phpstudy_pro\WWW\code0921\app\mobile\view\public\foot_bar.html";i:1707738454;}*/ ?>
<!DOCTYPE html>
...
<!--商户信息-->
    <div class="inner_box2">
        ...
        <button onclick="toggleForm()">切换商户信息</button>
        <div id="mer_control" class="mer_control active">
            <div><h3>商户信息</h3></div>

            <form action="<?php echo url('user/merchant_add'); ?>" method="post">
                <label>商户名称:<input type="text" name="store_name"></label><br>
                <label>商户地址:<input type="text" name="address"></label><br>
                <label>商家姓名 :<input type="text" name="name"></label><br>
                <label>门户照片:<input type="text" name="store_pic"></label><br>
                <label>行业:<input type="text" name="store_type"></label><br>
                <label>收款码:<input type="text" name="payment_code_pic"></label><br>
...
<!--汽车信息-->
        <div id="car_control" class="car_control">
            <div><h3>汽车信息</h3></div>
            <form action="<?php echo url('user/merchant_add'); ?>" method="post">
                <label>汽车名称:<input type="text" name="mer_name"></label><br>
                <label>车牌号:<input type="text" name="mer_name"></label><br>
                <label>汽车照片:<input type="text" name="mer_name"></label><br>
                <label>获取地点:<input type="text" name="mer_name"></label><br>
