<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\privatecode0921\app\mobile\view\user\car_edit.html";i:1707903039;s:72:"D:\phpstudy_pro\WWW\privatecode0921\app\mobile\view\public\foot_bar.html";i:1707797701;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="inner_box2">
        ...
        <div id="car_control" class="car_control" style="display: block">
            ...
            <form action="<?php echo url('user/car_update'); ?>" method="post" enctype="multipart/form-data">
                ...
                <label>汽车名称</label><br>
                <label><input type="text" value="<?php echo htmlentities($cardd_Data['car_name']); ?>"  name="car_name"></label><br>
                <label>车牌号</label><br>
                <label><input type="text" value="<?php echo htmlentities($cardd_Data['car_number']); ?>" name="car_number"></label><br>
                <label>获取地点</label><br>
