<?php /*a:1:{s:67:"D:\phpstudy_pro\WWW\privatecode0921\app\mobile\view\cart\index.html";i:1707738454;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="cart_box">
    ...
    <li class="item" data-id="<?php echo htmlentities($vo['id']); ?>">
      <div class="left_content">
        <input class="status" type="checkbox" <?php if($vo['status'] == 1): ?>checked<?php endif; ?> name="status">
      </div>
