<?php /*a:3:{s:74:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\ad\ad_type_add.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\head.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\foot.html";i:1708179639;}*/ ?>
<!--包含头部文件-->
...
<article class="page-container">
  ...
  <form class="form form-horizontal" id="form-article-add" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="row cl">
      ...
      <label class="form-label col-xs-4 col-sm-2">分组名称：</label>

      <div class="formControls col-xs-8 col-sm-9">

        <input type="text" class="input-text" value="" placeholder="" name="name" required="required">
