<?php /*a:3:{s:69:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\page\edit.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\head.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\foot.html";i:1708179639;}*/ ?>
<!--包含头部文件-->
  ...
  <form class="form form-horizontal" id="form-article-add" method="post" action="" enctype="multipart/form-data" >
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-6">
        ...
        <input type="text" class="input-text" value="<?php echo htmlentities($pageData['title']); ?>"  name="title" required="required">

        <input type="hidden" name="id" value="<?php echo htmlentities($pageData['id']); ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <script id="editor"  type="text/plain" name="content" style="width:100%;height:300px;"><?php echo $pageData['content']; ?></script>
