<?php /*a:3:{s:69:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\type\edit.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\head.html";i:1708179639;s:71:"D:\phpstudy_pro\WWW\privatecode0921\app\qingadmin\view\public\foot.html";i:1708179639;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 修改商品类型</div>
<article class="page-container">
  <form class="form form-horizontal" id="form-article-add" method="post" action="<?php echo url('type/update'); ?>" enctype="multipart/form-data" >
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">类型名称：</label>
      <div class="formControls col-xs-8 col-sm-6">
        <input type="text" class="input-text" value="<?php echo htmlentities($types['type_name']); ?>" required name="type_name">
        <input type="hidden" class="input-text" value="<?php echo htmlentities($types['id']); ?>" placeholder="" id="" name="id">
      </div>
    </div>
